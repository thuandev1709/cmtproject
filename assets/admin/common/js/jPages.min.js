 ...
 (function($, window, document, undefined) {
     ...
     Plugin.prototype = {
         ...
         getCSSAnimationSupport: function() {
             ...
             if (elm.style.animationName) animation = false;
             if (animation === false) {
         ...
         jQAnimations: function(page) {
             ...
             this._itemsShowing.show(0, 0).removeClass("jp-hidden");
             this._itemsOriented = this.getDirectedItems(page);
             this._index = 0;
             this._delay = setInterval(this.bind(function() {
                 if (this._index === this._itemsOriented.length) clearInterval(this._delay);
                 else {
                     this._itemsOriented.eq(this._index).show(this.options.fallback, 1);
                 }
                 this._index = this._index + 1;
             }, this), this.options.delay);
         },
         ...
         destroy: function() {
             ...
             else this._items.removeClass("jp-hidden").show(0, 1);
