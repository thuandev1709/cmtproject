...
<head>
    ...
    <title>Sign In Admin Cosmetic</title>
    <!-- Favicon-->
...
<body class="login-page">
    <div class="login-box">
        <!-- <div class="logo">
            <a href="javascript:void(0);">Admin<b> COSMETIC</b></a>
            <small></small>
        </div> -->
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST">
                    ...
                    <div class="msg"><h4>Đăng Nhập Vào Trang Quản Lý</h4></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <input type="submit" name="btn_login" id="btn_login" class="btn btn-block bg-pink waves-effect" value="  SIGN IN  ">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 msg" style="margin-bottom: 0px;">
                            <small>Liên hệ: lethanhthuan.dev@gmail.com</small>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        $("#error_message").delay(2000).fadeOut("fast");
    </script>
</body>
