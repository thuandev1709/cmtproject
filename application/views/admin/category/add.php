                    ...
                    <div class="form-group">
                        ...
                        <select name="cmt03_parents" class="form-control">
                            ...
                            <?php foreach ($list_cate_parent_max as $cate_parent) { ?>
                                <option value="<?php echo $cate_parent['cmt03_id_cate'].'_'.$cate_parent['cmt03_level'] ?>"><?php echo $cate_parent['cmt03_name'].' - (Menu cấp '.$cate_parent['cmt03_level'].')' ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="cmt03_name">Tên Loại</label>
                        <input type="text" id="cmt03_name" name="cmt03_name" class="form-control">
                    </div>
                    <div class="form-group">
                        <input type="radio" id="cmt03_active1" name="cmt03_active" value="1" class="with-gap" checked>
                        <label for="cmt03_active1">Active</label>

                        <input type="radio" id="cmt03_active2" name="cmt03_active" value="0" class="with-gap">
                        <label for="cmt03_active2" class="m-l-20">Not Active</label>
                    </div>
                    <input type="submit" name="btnAddCategory" id="btnAddCategory" class="btn bg-orange btn-lg waves-effect" value="Save">
